...
// <summary></summary>
// ***********************************************************************
namespace DNMOFT.Business.Base
{
    using System;
    using System.Linq;
    ...
    using DNMOFT.Business.Interface;
    using DNMOFT.DataAccess.Contexts;
    using DNMOFT.DataAccess.Interfaces;
    using DNMOFT.Repository.Interfaces;
    using DNMOFT.ViewModel.Base;
    using DNMOFT.ViewModel.Interfaces;
    using DNMOFT.ViewModel.jTable;

    using LinqKit;

    /// <summary>
    /// Class BusinessRule.
    /// Implements the <see cref="DNMOFT.Business.Interface.IBusinessRule{TR, TE, TV}" />
    /// </summary>
    ...
    /// <seealso cref="DNMOFT.Business.Interface.IBusinessRule{TR, TE, TV}" />
