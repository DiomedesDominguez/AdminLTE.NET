...
// ***********************************************************************
// <copyright file="mUserClaim.cs" company="DNMOFT">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
namespace AdminLTE.NET.DataAccess.Entities.Identity
{
    ...
    /// <summary>
    /// Class mUserClaim.
    /// Implements the <see cref="Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim{System.Int64}" />
    /// Implements the <see cref="AdminLTE.NET.DataAccess.Interfaces.IBaseEntity" />
    /// </summary>
    /// <seealso cref="Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim{System.Int64}" />
    /// <seealso cref="AdminLTE.NET.DataAccess.Interfaces.IBaseEntity" />
    [Table("mUsersClaims"),
    TrackChanges]
    public class mUserClaim : IdentityUserClaim<long>, IBaseEntity
    {
        #region Fields
        ...
        // the finalizer
        /// <summary>
        /// Finalizes an instance of the <see cref="mUserClaim"/> class.
        /// </summary>
        ~mUserClaim()
        {
            Dispose(false);
