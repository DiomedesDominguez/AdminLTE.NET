...
// <summary></summary>
// ***********************************************************************
namespace DNMOFT.Repository.Base
{
    using System;
    ...
    /// <summary>
    /// Class Repository.
    /// Implements the <see cref="DNMOFT.Repository.Interfaces.IRepository{TE}" />
    /// </summary>
    /// <typeparam name="TE">The type of the te.</typeparam>
    /// <seealso cref="DNMOFT.Repository.Interfaces.IRepository{TE}" />
