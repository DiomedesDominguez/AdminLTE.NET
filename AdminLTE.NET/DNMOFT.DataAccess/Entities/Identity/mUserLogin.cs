...
// ***********************************************************************
// <copyright file="mUserLogin.cs" company="DNMOFT">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
namespace DNMOFT.DataAccess.Entities.Identity
{
    ...
    /// <summary>
    /// Class mUserLogin.
    /// Implements the <see cref="Microsoft.AspNet.Identity.EntityFramework.IdentityUserLogin{System.Int64}" />
    /// Implements the <see cref="DNMOFT.DataAccess.Interfaces.IBaseEntity" />
    /// </summary>
    /// <seealso cref="Microsoft.AspNet.Identity.EntityFramework.IdentityUserLogin{System.Int64}" />
    ...
    public class mUserLogin : IdentityUserLogin<long>, IBaseEntity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="mUserLogin"/> class.
        /// </summary>
        public mUserLogin()
        {
            ClientIp = "127.0.0.1";
        ...
        // the finalizer
        /// <summary>
        /// Finalizes an instance of the <see cref="mUserLogin"/> class.
        /// </summary>
        ~mUserLogin()
        {
            Dispose(false);
